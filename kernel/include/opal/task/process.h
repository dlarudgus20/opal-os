...
[[nodiscard]] kerrno_t process_fork(const struct isr_stackframe *frame, procptr_t *proc_out, taskptr_t *task_out);
[[nodiscard]] kerrno_t process_exec_elf_file(struct process *proc, struct file *file, taskptr_t *task_out);
...
[[nodiscard]] kerrno_t process_load_elf_file(struct file *file, procptr_t *proc_out, taskptr_t *task_out);
