...
void linkedlist_push_front(
    struct linkedlist *restrict list, struct linkedlist_link *restrict to_insert) {
...
void linkedlist_insert_before(
    struct linkedlist_link *restrict link, struct linkedlist_link *restrict to_insert) {
